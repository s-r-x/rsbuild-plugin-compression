...
export interface IncludeExtraOptions {
  /**
   * @example
   * ```ts
   * ["**\/*.+(js|css)"]
  ...
  globs: string[];
  /**
   * {@link https://superchupu.dev/tinyglobby/documentation#caseSensitiveMatch}
   */
  caseSensitive?: boolean;
  /**
   * {@link https://superchupu.dev/tinyglobby/documentation#deep}
   */
  depth?: number;
  /**
   * {@link https://superchupu.dev/tinyglobby/documentation#dot}
   */
  dot?: boolean;
}
export interface CompressionPluginOptions {
  ...
  /**
   * Glob patterns for extra assets to include that were not in the rsbuild output (for example something from the public folder or some artifacts generated by other plugins)
   * The glob will work relative to the rsbuild output folder.
   *
   * {@link https://github.com/SuperchupuDev/tinyglobby | tinyglobby} is used for globbing
   * @example
   * ```ts
   * ["**\/*.+(js|css)"]
   * ```
   ...
   * ```
   */
  includeExtra?: string[] | IncludeExtraOptions;
  /**
